...
public class HttpClient3 {
    ...
    public static String doPost(String url, Map<String, Object> paramMap,Map<String,String> headers,Map<String,String> cookies) {
        // 获取输入流
        InputStream is = null;
        BufferedReader br = null;
        String result = null;
        ...
        try {
           ...
           String z= postMethod.getResponseBodyAsString();//直接返回
    ...
    public static String doPostJson(String url,String jsonstr) throws UnsupportedEncodingException {
        // 获取输入流
        InputStream is = null;
        BufferedReader br = null;
        String result = null;
